 ...
 * Получает массив $articles (3 последние статьи) от HomeController::index().
 */ ?>
...
<section>
    ...
    <div class="articles-grid">
        <?php /* Карточка для каждой из трёх свежих статей */ ?>
        <?php foreach ($articles as $article): ?>
        <div class="card">
            <h3><a href="<?= $_SERVER['SCRIPT_NAME'] ?>/articles/<?= $article['id'] ?>">
                <?= htmlspecialchars($article['title']) ?>
            </a></h3>
            <?php /* mb_substr — обрезка строки с поддержкой UTF-8 (кириллицы) */ ?>
